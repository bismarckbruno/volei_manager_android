...
La aplicación se proporciona **"tal cual" (as is)**, sin garantías de ningún tipo, expresas o implícitas. El desarrollador no se responsabiliza por:
* Pérdida de datos derivada de fallas del dispositivo;
* Actualizaciones del sistema operativo que puedan afectar el funcionamiento;
* Uso indebido de las funcionalidades de la aplicación.

### 4. Copias de seguridad y seguridad de datos
Como el almacenamiento es estrictamente local, se recomienda usar regularmente la función de **exportación/copia de seguridad** (CSV/JSON) para proteger su información. El desarrollador no tiene acceso a sus datos y no se responsabiliza por la recuperación de información no guardada o eliminada accidentalmente.
